document.getElementById('city').addEventListener('input', function () {
  ...
  daysInGeorgian[new Date().toLocaleDateString('en-US', { weekday: 'long' })];
        ...
        document.querySelector('.wind .value').textContent = dailyForecast[new Date().toLocaleDateString('en-US', { weekday: 'long' })].windSpeed + ' მ/წ';
        ...
        dayElements.forEach((dayElement, index) => {
            ...
            const georgianDay = daysInGeorgian[day]; // Translate to Georgian
            const data = dailyForecast[day];
            dayElement.textContent = georgianDay; // Use Georgian translation
